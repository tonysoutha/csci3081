/**
 * @file rtest2_local_simulator.cc
 *
 * @copyright 2019 3081 Staff, All rights reserved.
 */
#include "src/rtest2_local_simulator.h"
...
bool r2LocalSimulator::Start() {
  ...
  Stop * stop_CC_EB_7 = new Stop(4, 44.984540, -93.181692);  // Buford & Gartner
  Stop * stop_CC_EB_8 = new Stop(5, 44.984630, -93.186352);  // SPSC

  // CC Westbound stops
  Stop * stop_CC_WB_1 = new Stop(6, 44.984630, -93.186352);  // SPSC
  Stop * stop_CC_WB_2 = new Stop(7, 44.984482, -93.181657);  // Buford & Gartner
  Stop * stop_CC_WB_3 = new Stop(8, 44.983703, -93.178846);  // Fairgrounds
  Stop * stop_CC_WB_4 = new Stop(9, 44.980663, -93.180808);  // Tway
  Stop * stop_CC_WB_5 = new Stop(10, 44.976397, -93.221801);  // before transit
